...
interface AnthropicAiDialogueProps {
  open: boolean
...
function CredentialSelect({
  ...
  const { data: credentials } = useCredentials("anthropic_ai")
  return (
...
export function AnthropicAiDialogue({ open, onOpenChange, data, nodeId }: AnthropicAiDialogueProps) {
